...
TEXTS = {
    "uz": {
        ...
        "group_add_text": (
            ...
            "1️⃣ Tugmani bosing.\n"
            "2️⃣ Kerakli guruhni tanlang.\n"
            "3️⃣ Botni guruhga qo'shing."
        ),
        ...
        "help_text": (
            ...
            "👥 Guruhga qo'shish — botni guruhga qo'shish.\n\n"
    ...
    "ru": {
        ...
        "help_text": (
            ...
            "🌐 Язык — смена языка.\n"
            "👥 Добавить в группу — добавить бота в группу.\n\n"
...
def init_db():
    with closing(get_db()) as db:
        ...
        add_column_if_missing(db, "users", "username", "TEXT")
        add_column_if_missing(db, "users", "first_name", "TEXT")
        add_column_if_missing(db, "users", "language", "TEXT DEFAULT 'uz'")
        add_column_if_missing(db, "users", "phone", "TEXT")
        ...
        add_column_if_missing(db, "projects", "name_uz", "TEXT DEFAULT ''")
        add_column_if_missing(db, "projects", "name_ru", "TEXT DEFAULT ''")
        add_column_if_missing(db, "projects", "url", "TEXT DEFAULT ''")
        add_column_if_missing(
            db,
            "projects",
            "click_count",
        ...
        add_column_if_missing(db, "votes", "phone", "TEXT")
        add_column_if_missing(
            db,
            "votes",
            "created_at",
        ...
        add_column_if_missing(db, "news", "message_id", "INTEGER")
        add_column_if_missing(db, "news", "chat_id", "INTEGER")
        add_column_if_missing(db, "news", "text", "TEXT")
        add_column_if_missing(
            db,
            "news",
            "created_at",
